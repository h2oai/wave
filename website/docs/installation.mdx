...
Once the installation part is complete, you can use `wave init` command to pick a [predefined app templates](/docs/project-templates) that will bootstrap your first app and give you a head start when building your Wave apps.
