...
<video controls loop><source src={useBaseUrl('assets/docs/tutorial-counter__demo.mp4')} type='video/mp4'/></video>
...
<p><img alt="button" src={useBaseUrl('assets/docs/tutorial-counter__1.png')} /></p>
...
<video controls loop><source src={useBaseUrl('assets/docs/tutorial-counter__client.mp4')} type='video/mp4'/></video>
...
<video controls loop><source src={useBaseUrl('assets/docs/tutorial-counter__user-nosync.mp4')} type='video/mp4'/></video>
...
<video controls loop><source src={useBaseUrl('assets/docs/tutorial-counter__user-sync.mp4')} type='video/mp4'/></video>
