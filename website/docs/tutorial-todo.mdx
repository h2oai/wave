...
<p><img alt="todo" src={useBaseUrl('assets/docs/tutorial-todo__1.png')} /></p>
...
<video controls loop><source src={useBaseUrl('assets/docs/tutorial-todo__2.mp4')} type='video/mp4'/></video>
...
<video controls loop><source src={useBaseUrl('assets/docs/tutorial-todo__3.mp4')} type='video/mp4'/></video>
...
<video controls loop><source src={useBaseUrl('assets/docs/tutorial-todo__4.mp4')} type='video/mp4'/></video>
...
<video controls loop><source src={useBaseUrl('assets/docs/tutorial-todo__5.mp4')} type='video/mp4'/></video>
