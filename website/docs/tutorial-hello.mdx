...
<p><img alt="Hello World 1" src={useBaseUrl('assets/docs/tutorial-hello__1.png')} /></p>
...
<p><img alt="Hello World 2" src={useBaseUrl('assets/docs/tutorial-hello__2.png')} /></p>
...
<p><img alt="Hello World 3" src={useBaseUrl('assets/docs/tutorial-hello__3.png')} /></p>
