...
As the name suggests, this is a component to be used for text annotation purposes, this is very handy for NLP-related needs.
...
Used when you need to show who has access or who is included within a specified workflow.
...
The intended use of this card is to "lead into" another page.
