...
v = page.add('example', ui.plot_card(
    box='1 1 4 5',
    title='Area + Line, groups - Ice Cream Sales different brands',
    data=data('date brand sales', len(ice_cream_sales)),
    plot=ui.plot([ui.mark(type='area', x_scale='time', x='=date', y='=sales', color='=brand', y_min=300),
                  ui.mark(type='line', x='=date', y='=sales', color='=brand')])
))
