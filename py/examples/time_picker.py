...
async def serve(q: Q):
    if q.args.show_inputs:
        q.page['example'].items = [
            ...
            ui.text(f'timepicker_h12={q.args.timepicker_h12}'),
        ...
        q.page['example'] = ui.form_card(box='1 1 4 10', items=[
            ...
            ui.time_picker(name='timepicker_h12', label="Time picker with 12 hour time format", hour_cycle='h12', value="10:35"),
