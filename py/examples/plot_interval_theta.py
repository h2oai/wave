...
v = page.add('example', ui.plot_card(
    box='1 1 4 5',
    title='Intervals, theta, stacked - Fruit popularity in different states',
    data=data('state fruit popularity', len(fruit_popularity)),
    plot=ui.plot(
        [ui.mark(coord='theta', type='interval', x='=popularity', y='=state', color='=fruit', stack='auto', y_min=0)])
))
