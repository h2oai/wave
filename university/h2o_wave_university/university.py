...
university_dir = os.path.dirname(os.path.realpath(__file__))
...
async def setup_page(q: Q):
    py_content = ''
    parser_path = os.path.join(university_dir, 'autocomplete_parser.py')
    utils_path = os.path.join(university_dir, 'autocomplete_utils.py')
    # In prod.
