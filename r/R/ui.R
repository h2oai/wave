...
#' @param visible True if the component should be visible. Defaults to True.
#' @param path_popup The path or URL or data URL of the high resolution image. Enables image zoom popup when clicking on the image. E.g. `/foo.png` or `http://example.com/foo.png` or `data:image/png;base64,???`.
