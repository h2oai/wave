...
type Conf struct {
	...
	NoAppDropIfUnresponsive bool   `cfg:"no-unresponsive-app-drop" env:"H2O_WAVE_NO_UNRESPONSIVE_APP_DROP" cfgDefault:"false" cfgHelper:"do not unregister unresponsive apps when unreachable"`
